...
internal class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        X509Certificate2Collection certificates2 = store.Certificates;
        foreach (X509Certificate2 cert in certificates2)
        {
        ...
        Console.WriteLine($"Found Certificate {certificates.First().SubjectName.Name}");

        // Encrypt
        RSA alg = certificates.FirstOrDefault().GetRSAPublicKey();
        ...
        // Decrypt
        RSA alg2 = certificates.FirstOrDefault()?.GetRSAPrivateKey()!;
